...
export const MenuBackdrop = () => {
  return (
    <div aria-hidden className="absolute inset-0 overflow-hidden bg-[#10131c]">
      <div className="absolute inset-0 scale-[1.06] bg-[url('/images/background/backdrop_day.png')] bg-cover bg-center blur-[4px] brightness-90 [image-rendering:pixelated]" />
      <div className="animate-drift absolute left-0 right-0 top-[60px] h-[210px] bg-[url('/images/background/cloud_day.png')] bg-repeat-x opacity-65 blur-[3px] [background-size:auto_150px] [image-rendering:pixelated]" />
